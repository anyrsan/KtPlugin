package com.any.gradle

import com.android.build.api.transform.*
import com.android.build.gradle.AppExtension
import com.android.build.gradle.internal.pipeline.TransformManager
import com.any.gradle.asm.AnyClassVisitor
import com.any.gradle.common.Constant
import com.any.gradle.common.ConvertMap
import com.any.gradle.common.Log
...
class MyCustomPlugin : Transform(), Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        //引入自定义参数
        val extension = project.extensions.create("ak", CustomData::class.java)
